        ...
        <div className="section pp-scrollable slide-personal-contacts">
            ...
            <div className="container">
                ...
                <div className="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <div className="contact-personal-card-detail animate-element delay7 fadeInUp">
                        ...
                        <div className="col-xl-7 col-lg-10">
                            ...
                            <div className="slide-title-sub">50 North Beech St. west toronto, CA 076</div>
                            <div className="slide-title-sub"><a href="tel:+7068980751" className="phone-link">(+706) 898-0751</a></div>
                            <div className="text-md text-uppercase"><a href="mailto:hayley.design@gmail.com" className="text-primary"><strong>hayley.design@gmail.com</strong></a></div>
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div className="col-lg-5 animate-element delay7 fadeInUp">
                    <div className="slide-title-info">Let's grab a coffee and jump on  conversation <span className="text-primary">chat with me.</span></div>
                    ...
                    <div className="form-group form-group-material a-form-group">
                        ...
                        <textarea className="form-control" name="message" cols="30" rows="3"></textarea>
                    </div>
                    <div className="form-group control-file a-file">
                        ...
                        <input className="file-path form-control" placeholder="Add Attachment(.doc;.pdf)" />
                        </div>
                    </div>
